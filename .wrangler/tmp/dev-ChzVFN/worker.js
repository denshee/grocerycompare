...
// .wrangler/tmp/bundle-EPZZKh/checked-fetch.js
...
function groupByProduct(listings) {
  ...
  for (const listing of listings) {
    ...
    if (n.includes("eggs")) {
      ...
      let size = sizeMatch ? sizeMatch[0].replace(/\s/g, "") : "1l";
...
// .wrangler/tmp/bundle-EPZZKh/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-EPZZKh/middleware-loader.entry.ts
