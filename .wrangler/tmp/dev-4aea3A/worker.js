...
// .wrangler/tmp/bundle-zlTbEc/checked-fetch.js
    ...
    try {
      if (url.pathname === "/api/search") {
        ...
        try {
          ...
          const grouped = groupByProduct(matched).sort((a, b) => b.prices.length - a.prices.length);
...
// .wrangler/tmp/bundle-zlTbEc/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-zlTbEc/middleware-loader.entry.ts
